...
contract RedeemTest is BaseTest {
    ...
    uint256 public constant redeemableoToken = 10e6 * 1e18;
    ...
    function setUp() public {
        ...
        oToken.addMinter(address(claim));
    }
    ...
    function testClaimAirdrop() public {
        ...
        uint256 preBalance = oToken.balanceOf(user);
        ...
        uint256 postBalance = oToken.balanceOf(user);
