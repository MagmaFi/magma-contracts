...
contract RedeemTest is BaseTest {
    ...
    uint256 public constant redeemableMAGMA = 10e6 * 1e18;
    ...
    function setUp() public {
        ...
        MAGMA.setMerkleClaim(address(claim));
    }
    ...
    function testClaimAirdrop() public {
        ...
        uint256 preBalance = MAGMA.balanceOf(user);
        ...
        uint256 postBalance = MAGMA.balanceOf(user);
