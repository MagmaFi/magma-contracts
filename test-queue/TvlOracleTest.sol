...
contract TvlOracleTest is BaseTest {
    ...
    function setUp() public {
        ...
        USDC.mint(address(this), TOKEN_100e6);
        USDC.approve(address(router2), TOKEN_100e6);
        oToken.mint(address(this), TOKEN_100);
        oToken.approve(address(router2), TOKEN_100);
        router2.addLiquidity(address(oToken), address(USDC), false, TOKEN_100, TOKEN_100e6, 0, 0, address(this), block.timestamp);
